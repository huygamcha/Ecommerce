  ...
  const columns = [
    {
      ...
      render: (text: string, record: any, index: number) => {
        if (record.column === 4) {
          ...
          return null; // Không render gì cả nếu không thỏa điều kiện
        }
      },
    },
    {
    ...
    },
    {
      ...
      render: (text: any, record: any) => {
        ...
        else return null; // Không render gì cả nếu không thỏa điều kiện
      },
    },
  ];
  return (
