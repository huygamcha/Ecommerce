...
function PolicyFooter() {
  return (
    <div className={clsx(style.policy_wrapper_preFooter)}>
          ...
          <Col span={12}>
            <div>
              <Flex vertical align="center">
                ...
                <Flex vertical>
                  <div className={clsx(style.policy_main_header)}>
                    Đổi trả trong 30 ngày
                  </div>
                  <div className={clsx(style.policy_sub_header)}>
                    kể từ ngày mua hàng
                  </div>
                </Flex>
              </Flex>
